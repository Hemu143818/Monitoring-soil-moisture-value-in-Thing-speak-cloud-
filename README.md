...
char ssid[] = "hemu";   // your network SSID (name) 
...
```
## CIRCUIT DIAGRAM:
![Screenshot 2024-12-19 210505](https://github.com/user-attachments/assets/e0fff671-0043-459c-9bd6-04ffc8e2d53d)

## OUTPUT:
![Screenshot 2024-12-19 210450](https://github.com/user-attachments/assets/de55cc48-aa2e-4a10-b292-255414105565)
